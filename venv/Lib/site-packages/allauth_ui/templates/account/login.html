...
{% load static %}
{% block content %}
    <div class="organizer" style="display: flex;justify-content: space-between;">
        <div class="box" style="width: 100%;padding: 20px;box-sizing: border-box;">
            <img src="{% static 'images/logo_login.png' %}" alt="" srcset="">
        </div>
        <div class="box" style="width: 100%;padding: 20px;box-sizing: border-box;">
